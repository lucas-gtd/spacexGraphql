...
export type GetLaunchListQuery = (
  { __typename?: 'Query' }
...
export const GetLaunchListDocument = gql`
  ...
  export class GetLaunchListGQL extends Apollo.Query<GetLaunchListQuery, GetLaunchListQueryVariables> {
    document = GetLaunchListDocument;
